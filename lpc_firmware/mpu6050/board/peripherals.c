...
/***********************************************************************************************************************
 * MPU6050_PINT initialization code
 **********************************************************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
  ...
  - general:
    - interrupt_array:
      - 0:
        ...
        - callback_function: 'MPU6050_PINTCallback'
...
static void MPU6050_PINT_init(void) {
  /* MPU6050_PINT initiation  */
  PINT_Init(MPU6050_PINT_PERIPHERAL);
  /* MPU6050_PINT PINT.0 configuration */
  PINT_PinInterruptConfig(MPU6050_PINT_PERIPHERAL, MPU6050_PINT_INT, kPINT_PinIntEnableRiseEdge, MPU6050_PINTCallback);
}
