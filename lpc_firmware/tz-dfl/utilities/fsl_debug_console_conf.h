...
/* Debug console configuration check */
    ...
    #error SDK_DEBUGCONSOLE has already been defined and the value is not 1 as value in the DebugConsole component instance setting.
#endif

#if (!defined(SDK_DEBUGCONSOLE_UART))
    #error SDK_DEBUGCONSOLE_UART is not defined. Define SDK_DEBUGCONSOLE_UART at the project setting.
#endif

#if (!defined(DEBUG_CONSOLE_TRANSFER_NON_BLOCKING))
    #error DEBUG_CONSOLE_TRANSFER_NON_BLOCKING is not defined. Define DEBUG_CONSOLE_TRANSFER_NON_BLOCKING at the project setting.
#endif

#if ((defined(SERIAL_PORT_TYPE_UART) && (SERIAL_PORT_TYPE_UART != 1)))
    #error SERIAL_PORT_TYPE_UART define value is not 1 as value in the DebugConsole component instance setting.
#elif (!defined(SERIAL_PORT_TYPE_UART))
    #error SERIAL_PORT_TYPE_UART is not defined. Define SERIAL_PORT_TYPE_UART=1 at the project setting.
#endif

#if ((defined(SERIAL_PORT_TYPE_SWO) && (SERIAL_PORT_TYPE_SWO != 0)))
    #error The SERIAL_PORT_TYPE_SWO define value is not 0 as value in the DebugConsole component instance setting.
#endif
 ...
 * This value will affect the RAM's ultilization, should be set per platform's capability and software requirement.
...
#define DEBUG_CONSOLE_TRANSMIT_BUFFER_LEN (1024U)
...
#define DEBUG_CONSOLE_SCANF_MAX_LOG_LEN (256U)
...
/*! @brief RTOS synchronization mechanism to avoid multitask log print mess.
