...
static void PINT_init(void) {
  ...
  PINT_PinInterruptConfig(PINT_PERIPHERAL, PINT_S3, kPINT_PinIntEnableFallEdge, UserButton);
...
- config_sets:
  - fsl_debug_console:
    - config:
      ...
      - DEBUG_CONSOLE_SCANF_MAX_LOG_LEN: '256'
    ...
    - peripheral_config:
      ...
      - uart_config:
        ...
        - clockSourceFreq: 'BOARD_BootClockPLL150M'
        - baudRate_Bps: '115200'
        - interrupt_sources_flexcomm_usart: 'kUSART_TxLevelInterruptEnable kUSART_RxLevelInterruptEnable'
...
static void DebugConsole_init(void) {
  ...
  USART_EnableInterrupts(DEBUGCONSOLE_SERIAL_PERIPHERAL, (kUSART_TxLevelInterruptEnable | kUSART_RxLevelInterruptEnable));
