...
usb_device_class_config_struct_t g_CompositeClassConfig[USB_DEVICE_CLASS_INTERFACE_COUNT] = {
    {
...
usb_device_class_config_list_struct_t g_UsbDeviceCompositeConfigList = {
    g_CompositeClassConfig, USB_DeviceCallback, USB_DEVICE_CLASS_INTERFACE_COUNT,
};
