 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
BOARD_InitDEBUG_UARTPins:
- options: {callFromInitBoot: 'true', prefix: DEBUG_USART_PINS_, coreID: cm33_core0, enableClock: 'true'}
- pin_list:
...
void BOARD_InitDEBUG_UARTPins(void)
{
    ...
    IOCON_PinMuxSet(IOCON, DEBUG_USART_PINS_DEBUG_UART_RX_PORT, DEBUG_USART_PINS_DEBUG_UART_RX_PIN, DEBUG_UART_RX);
    ...
    IOCON_PinMuxSet(IOCON, DEBUG_USART_PINS_DEBUG_UART_TX_PORT, DEBUG_USART_PINS_DEBUG_UART_TX_PIN, DEBUG_UART_TX);
}
