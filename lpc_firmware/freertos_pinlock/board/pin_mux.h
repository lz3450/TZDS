...
/*! @name PIO0_29 (number 92), P8[2]/U6[13]/FC0_USART_RXD
  @{ */
#define DEBUG_USART_PINS_DEBUG_UART_RX_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define DEBUG_USART_PINS_DEBUG_UART_RX_PIN 29U                   /*!<@brief PORT pin number */
#define DEBUG_USART_PINS_DEBUG_UART_RX_PIN_MASK (1U << 29U)      /*!<@brief PORT pin mask */
                                                                 /* @} */

/*! @name PIO0_30 (number 94), P8[3]/U6[12]/FC0_USART_TXD
  @{ */
#define DEBUG_USART_PINS_DEBUG_UART_TX_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define DEBUG_USART_PINS_DEBUG_UART_TX_PIN 30U                   /*!<@brief PORT pin number */
#define DEBUG_USART_PINS_DEBUG_UART_TX_PIN_MASK (1U << 30U)      /*!<@brief PORT pin mask */
                                                                 /* @} */
