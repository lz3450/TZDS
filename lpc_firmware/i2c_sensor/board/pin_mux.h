...
/*! @name PIO1_21 (number 30), P17[3]/P24[6]/FC4_I2C_SDA_ARD
  @{ */
#define FC4_I2C_SDA_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define FC4_I2C_SDA_PIN 21U                   /*!<@brief PORT pin number */
#define FC4_I2C_SDA_PIN_MASK (1U << 21U)      /*!<@brief PORT pin mask */
                                              /* @} */

/*! @name PIO1_20 (number 4), P17[1]/P24[5]/FC4_I2C_SCL_ARD
  @{ */
#define FC4_I2C_SCL_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define FC4_I2C_SCL_PIN 20U                   /*!<@brief PORT pin number */
#define FC4_I2C_SCL_PIN_MASK (1U << 20U)      /*!<@brief PORT pin mask */
                                              /* @} */
...
/* Symbols to be used with GPIO driver */
#define ACCL_INTR_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define ACCL_INTR_GPIO_PIN_MASK (1U << 19U) /*!<@brief GPIO pin mask */
#define ACCL_INTR_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define ACCL_INTR_PIN 19U                   /*!<@brief PORT pin number */
#define ACCL_INTR_PIN_MASK (1U << 19U)      /*!<@brief PORT pin mask */
                                            /* @} */
