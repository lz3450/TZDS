...
static void led_red_blink(void *pvParameters)
{
    for (;;)
    {
        GPIO_PortToggle(GPIO, BOARD_INITLEDSPINS_LED_RED_PORT, BOARD_INITLEDSPINS_LED_RED_PIN_MASK);
...
static void led_green_blink(void *pvParameters)
{
    for (;;)
    {
        GPIO_PortToggle(GPIO, BOARD_INITLEDSPINS_LED_GREEN_PORT, BOARD_INITLEDSPINS_LED_GREEN_PIN_MASK);
