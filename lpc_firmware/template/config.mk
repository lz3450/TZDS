...
#### phy
# includedirs += usb/phy
# src += usb/phy/usb_phy.c

## mutually exclusive options
# includedirs += usb/output/npw/device_config/ip3511fs
# includedirs += usb/output/npw/device_config/ip3511hs
...
### device class
# includedirs += usb/output/source/device
# src += usb/output/source/device/usb_device_ch9.c

# includedirs += usb/output/source/device/class
# src += usb/output/source/device/class/usb_device_class.c
## mutually exclusive options
# src += usb/output/source/device/class/usb_device_audio.c

# src += usb/output/source/device/class/usb_device_cdc_acm.c
# sdk_config += USB_DEVICE_CONFIG_CDC_ACM=1

# src += usb/output/source/device/class/usb_device_hid.c
# src += usb/output/source/device/class/usb_device_msc_ufi.c
# src += usb/output/source/device/class/usb_device_printer.c
# src += usb/output/source/device/class/usb_device_ccid.c
# src += usb/output/source/device/class/usb_device_cdc_rndis.c
# src += usb/output/source/device/class/usb_device_dfu.c
# src += usb/output/source/device/class/usb_device_msc.c
# src += usb/output/source/device/class/usb_device_phdc.c
# src += usb/output/source/device/class/usb_device_video.c

#### generated
# includedirs += source/generated
# src += source/generated/usb_device_composite.c
# src += source/generated/usb_device_descriptor.c
