...
void BOARD_BootClockPLL150M(void)
{
    ...
    #endif
    #if FSL_CLOCK_DRIVER_VERSION >= MAKE_VERSION(2, 3, 4)
      CLOCK_SetClkDiv(kCLOCK_DivFlexFrg4, 144U, false);         /*!< Set DIV to value 0xFF and MULT to value 144U in related FLEXFRGCTRL register */
    #else
      CLOCK_SetClkDiv(kCLOCK_DivFlexFrg4, 37120U, false);         /*!< Set DIV to value 0xFF and MULT to value 144U in related FLEXFRGCTRL register */
    #endif
    ...
    CLOCK_AttachClk(kPLL0_DIV_to_FLEXCOMM4);                 /*!< Switch FLEXCOMM4 to PLL0_DIV */

    /*!< Set SystemCoreClock variable. */
    SystemCoreClock = PLL150M_CORE_CLOCK;
#endif
}
