...
const std::string BranchVFGNode::toString() const
{
    std::string str;
    std::stringstream rawstr(str);
    rawstr << "\"type\": \"BranchVFGNode\"";
    rawstr << ",\n";
    rawstr << "\"id\": \"" << getId() << "\"";
    rawstr << ",\n";
    rawstr << brstmt->toString();
    return rawstr.str();
}
...
const std::string ActualParmVFGNode::toString() const
{
    std::string str;
    std::stringstream rawstr(str);
    rawstr << "\"type\": \"ActualParmVFGNode\"";
    rawstr << ",\n";
    rawstr << "\"id\": \"" << getId() << "\"";
    rawstr << ",\n";
    rawstr << getCallSite()->getCallSite()->getSourceLoc();
    rawstr << ",\n";
    rawstr << param->toString();
...
const std::string FormalParmVFGNode::toString() const
{
    std::string str;
    std::stringstream rawstr(str);
    rawstr << "\"type\": \"FormalParmVFGNode\"";
    rawstr << ",\n";
    rawstr << "\"id\": \"" << getId() << "\"";
    rawstr << ",\n";
    rawstr << "\"f\": \"" << getFun()->getName() << "\"";
...
const std::string NullPtrVFGNode::toString() const
{
    std::string str;
    std::stringstream rawstr(str);
    rawstr << "\"type\": \"NullPtrVFGNode\"";
    rawstr << ",\n";
    rawstr << "\"id\": \"" << getId() << "\"";
    rawstr << ",\n";
    rawstr << "\"PAGNode\": \"" << node->getId() << "\"";
    return rawstr.str();
}
