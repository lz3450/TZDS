...
CmpStmt::CmpStmt(SVFVar* s, const OPVars& opnds, u32_t pre)
    : MultiOpndStmt(s, opnds,
                    makeEdgeFlagWithAdditionalOpnd(SVFStmt::Cmp, opnds.at(1))),
      predicate(pre)
{
...
SelectStmt::SelectStmt(SVFVar* s, const OPVars& opnds, const SVFVar* cond)
    : MultiOpndStmt(s, opnds,
                    makeEdgeFlagWithAdditionalOpnd(SVFStmt::Select, opnds.at(1))),
      condition(cond)
{
...
BinaryOPStmt::BinaryOPStmt(SVFVar* s, const OPVars& opnds, u32_t oc)
    : MultiOpndStmt(
          s, opnds,
          makeEdgeFlagWithAdditionalOpnd(SVFStmt::BinaryOp, opnds.at(1))),
      opcode(oc)
{
